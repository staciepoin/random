! function() {
  Function && Function.prototype && Function.prototype.bind && (/MSIE [678]/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || ! function(t) {
    ...
    return e.e = function(t, e) {}, e.e = function(t, n) {
      ...
      if (void 0 !== i[t]) i[t].push(n);
        ...
        o.type = "text/javascript", o.charset = "utf-8", o.async = !0, o.onerror = function() {
          ...
          1: "05e7e425be6c9666bb94609e01a537c8",
          2: "4e56ff84e57afaf5af2506ef73ab8a88",
          3: "49424eb5f95cfd0b90d7eb4357628058",
          4: "4a58f93fb4cda890c3919038cf578c1e",
          5: "322dce046ac5e6f5607a78e3142bd35d",
          6: "f8bf188a26c0fb191f8cdd1eb88ad3c7",
          7: "5e33f296a9ed7a390e3d5ab84d0ba34e"
    ...
    var r, i = n(1),
      ...
      m = n(257),
      g = "_e";
    s.set("widgets.init", !0), u.set("init", !0), m(), r = new i, a.exposeReadyPromise(r.promise, u.base, g), u.set("widgets", h), u.set("widgets.load", l.load), u.set("events", f), s.init("host", "platform.twitter.com"), v(function() {
    ...
    (function(t) {
      ...
      (function() {
        ...
        function v() {
          try {
            var t = n(5);
            return V = t.runOnLoop || t.runOnContext, d()
          } catch (e) {
            return h()
          }
        }
        ...
        function L(t, e) {
          var n = this;
          n._instanceConstructor = t, n.promise = new t(m), n._validateInput(e) ? (n._input = e, n.length = e.length, n._remaining = e.length, n._init(), 0 === n.length ? T(n.promise, n._result) : (n.length = n.length || 0, n._enumerate(), 0 === n._remaining && T(n.promise, n._result))) : I(n.promise, n._validationError())
        }
        ...
        function z(t) {
          ...
          for (var o = t.length, a = 0; i._state === nt && o > a; a++) P(r.resolve(t[a]), void 0, e, n);
          return i
        }
    ...
    function i(t) {
      return t = t || m, /(Trident|MSIE|Edge[\/ ]?\d)/.test(t)
    }

    function o(t) {
      return t = t || m, /MSIE 9/.test(t)
    }

    function a(t) {
      return t = t || m, /(iPad|iPhone|iPod)/.test(t)
    }

    function s(t) {
      return t = t || m, /^Mozilla\/5\.0 \(Linux; (U; )?Android/.test(t)
    }

    function u(t, e) {
      return t = t || p, e = e || m, t.postMessage && !(i(e) && t.opener)
    }

    function c(t, e, n) {
      return t = t || p, e = e || h, n = n || m, "ontouchstart" in t || /Opera Mini/.test(n) || e.msMaxTouchPoints > 0
    }
    ...
    function o(t, e) {
      var n = b.decodeURL(t);
      return e = e || !1, n.screen_name = i(t), n.screen_name ? b.url("https://twitter.com/intent/" + (e ? "follow" : "user"), n) : void 0
    }
    ...
    function d(t) {
      return Array.isArray(t) || (t = [t]), t.reduce(function(t, e) {
        var n, r = v.stringify(e),
          i = f(r);
        return g > b + i ? t = t.concat(r) : (n = v.splitLogEntry(e), n.length > 1 && (t = t.concat(d(n)))), t
      }, [])
    }
    ...
    var h = n(33),
      ...
      g = 2083,
      y = [],
      w = p.url(v.CLIENT_EVENT_ENDPOINT, {
        dnt: 0,
        l: ""
      }),
    ...
    function o(t, e, n) {
      ...
      return t = a("tfw_client_event", t, r), t.client_version = m, t.format_version = void 0 !== n ? n : 1, e || (t.widget_origin = r), t
    }
    ...
    function i() {
      ...
      return v.isFalseValue(t) ? !1 : v.isTruthValue(t) ? c.body : c.querySelectorAll(t)
    }

    function o(t) {
      var e;
      return t = t || c.body, t = t.length ? m.toRealArray(t) : [t], h.pause(), e = u.allResolved(r(t).map(function(t) {
    ...
    function u() {
      ...
      return C++, t.action = w.CLIENT_EVENT_ENDPOINT, t.method = "POST", t.target = x + C, t.id = A + C, e.type = "hidden", e.name = "dnt", e.value = m.enabled(), n.type = "hidden", n.name = "tfw_redirect", n.value = w.RUFOUS_REDIRECT, t.appendChild(e), t.appendChild(n), t
    }
    ...
    t.exports = [n(74), n(106), n(122), n(155), n(161), n(167), n(212), n(224), n(229)]
  }, function(t, e, n) {
    function r(t) {
    ...
    t.exports = {
      css: "2babfe8e8f5283853b62cb0d4f9637d7"
    }
  }, , function(t, e, n) {
    function r(t) {
    ...
    ! function() {
      var e = function(t, n) {
        function r() {
          ...
          var t, e;
          this.call = function() {
            for (t = 0, e = this.q.length; e > t; t++) this.q[t].call()
          }
        }
        ...
        if (s)
          for (var u = 0, c = t.length; c > u; u++) o(t[u], n);
        else o(t, n);
        this.detach = function() {
          if (s)
            for (var n = 0, r = t.length; r > n; n++) e.detach(t[n]);
          else e.detach(t)
        }
      };
      e.detach = function(t) {
    ...
    function r(t) {
      return t ? t.replace(/[^\w\$]/g, "_") : void 0
    }
    ...
    function r(t) {
      var e = t || [];
      return e.unshift("video/event"), d(e)
    }

    function i(t) {
      var e = t || [];
      return e.unshift("grid/collection"), d(e)
    }

    function o(t) {
      var e = t || [];
      return e.unshift("moments"), d(e)
    }

    function a(t) {
      var e = t || [];
      return e.unshift("timeline"), d(e)
    }

    function s(t) {
      var e = t || [];
      return e.unshift("widgets/timelines"), d(e)
    }

    function u(t) {
      var e = t || [];
      return e.unshift("tweets.json"), d(e)
    }

    function c(t) {
      var e = t || [];
      return e.unshift("widgets/video"), d(e)
    }
    ...
    var p = n(14),
      ...
      m = p.get("backendHost") || v;
    t.exports = {
      eventVideo: r,
      grid: i,
      moment: o,
      timeline: a,
      timelinePreconfigured: s,
      tweetBatch: u,
      video: c
    }
  }, function(t, e, n) {
    ...
    function l(t) {
      v.inlineStyle() || (f(t, ".MediaCard-widthConstraint", "maxWidth", w), f(t, ".MediaCard-mediaContainer", "paddingBottom", E), f(t, ".CroppedImage-image", "top", b), f(t, ".CroppedImage-image", "left", _))
    }
    var h = n(7),
      p = n(11),
      v = n(66),
    ...
    function r(t, e, n, r, i) {
      var o = s(t, n, r, i);
      return o ? u.createPlayerForTweet(o.element, e, o.options) : void 0
    }

    function i(t, e, n, r, i) {
      var o, a = s(t, n, r, i);
      return a ? (o = u.createPlayerForLiveVideo(a.element, e, a.options), o.on("ready", function() {
        o.playPreview()
      }), o) : void 0
    }
    ...
    function o(t) {
      var e = t.querySelector(".wvp-player-container"),
        n = e && u.findPlayerForElement(e);
      return n ? n.teardown() : void 0
    }

    function a(t) {
      return u.findPlayerForElement(t)
    }
    ...
    function s(t, e, n, r) {
      ...
      return i = c(t, ".wvp-player-container"), i.length > 0 ? (d && u.setBaseUrl(d), {
        element: i[0],
        options: o
      }) : void 0
    }
    ...
    function r(t) {
      ...
      return i.dataSource = c(i), o.aug(e, o.compact(i))
    }
    ...
    var r = n(11);
    t.exports = r.aug({}, n(246), n(248), n(249), n(250), n(251), n(252), n(253), n(254), n(255))
  }, function(t, e, n) {
    var r = n(80),
      i = n(247),
      o = i(["userId"], {}, r);
